...
var (
	...
	htmlTemplate = template.Must(template.New("github.com/mmavka/dataframe-go/plot/html").Parse(titleHTML))
	imgTemplate  = template.Must(template.New("github.com/mmavka/dataframe-go/plot/img").Parse(imgHTML))
)
